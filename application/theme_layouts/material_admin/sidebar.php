    ...
    <div class="scrollbar-inner">
        ...
        <ul class="navigation">
            ...
            <li class="<?php echo ($this->router->fetch_class() === 'moduleservice') ? 'navigation__active' : '' ?>">
                <a href="<?php echo base_url('panel/moduleservice/') ?>">Layanan</a>
            </li>
            ...
            <li class="<?php echo ($this->router->fetch_class() === 'modulesyarat') ? 'navigation__active' : '' ?>">
                <a href="<?php echo base_url('panel/modulesyarat/') ?>">Syarat</a>
            </li>
            <li class="<?php echo ($this->router->fetch_class() === 'modulestok') ? 'navigation__active' : '' ?>">
                <a href="<?php echo base_url('panel/modulestok/') ?>">Stok</a>
            </li>
        </ul>
        </li>
